...
from .views.company_search import QueryPlay, QueryImproveForeign, QueryImproveReverseForeign
...
urlpatterns = [
    ...
    path('query_play/', QueryPlay.as_view(), name='engineer-list'),
    path('query_foreign/', QueryImproveForeign.as_view(), name='related-test'),
    path('query_reverse_foreign/', QueryImproveReverseForeign.as_view(), name='related-test'),
